# GLOSSARY — Inteligencia Artificial
...
**Definição:** Abordagem que busca sequências de ações para atingir objetivos em um modelo explícito de estados.
**Sinônimos aceitos:** planning
**Não confundir com:** busca adversária
**Aparece em:** Unidade de Aprendizagem 3 — Raciocínio, Planejamento e Representação de Conhecimento

## Revisão de probabilidade
**Definição:** Conceito central de raciocínio sob incerteza usado para modelar crenças e atualizar evidências.
**Sinônimos aceitos:** inferência probabilística
**Não confundir com:** lógica determinística
**Aparece em:** Unidade de Aprendizagem 4 — Raciocínio sob Incerteza
